...
#        self.goldFilename = "./images/gold2.gif" 
#        self.wumpusFilename = "./images/wumpus2.gif" 
#        self.pitFilename = "./images/pit2.gif"
#        self.agentFilename = "./images/agent2.gif" 
#        self.doorFilename = "./images/door.gif" 
#        self.keyFilename = "./images/key.gif" 
#        self.robot_goldFilename = "./images/robot_gold.gif" 
#        self.robot_wumpusFilename = "./images/robot_wumpus.gif" 
#        self.robot_doorFilename = "./images/robot_door.gif" 
#        self.robot_keyFilename = "./images/robot_key.gif" 
#        self.exitFilename = "./images/exit.gif" 
        # --------------------------------------------------------
    ...
    def redraw(self):
        ...
        for x in range(self.cols):
            for y in range(self.rows):
                #print x, y, self.location[0], self.location[1], self.world[x][y]
                #if x == self.location[0] and self.location[1] == y: print "harrl"
                #else: print 'norl'
                posx = x * 50
